...
当前已提供从 ecat 提取的测试发布与候选执行包：AI 填一份项目配置，即可生成流水线、固定 TAT 命令及主机工件。一个服务与三个服务的两份样例已完成本地生成和接口验证，公共核心相同；新包的云端部署、生产与恢复尚未验收。具体入口见[接入步骤](references/bootstrap.md)。
...
[MIT](LICENSE)。新提取的应用来源代码另见[来源与许可记录](assets/cnb-tcr-tat/dependencies/SOURCES.md)，外部分发许可尚待核对；当前包用于本地验证。
