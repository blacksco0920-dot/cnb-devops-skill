...
After migration may have started, any failure retains the transaction and blocks another ordinary apply. No database rollback is inferred. A production adapter, existing-runtime baseline import, dependency bootstrap and independent recovery/restore execution remain separate work.
