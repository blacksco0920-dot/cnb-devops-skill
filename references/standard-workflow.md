...
0.2 包已完成 FinAgent 三轮真实重装、测试与候选、同镜像生产、业务与离机恢复，耗时及限制见[完整演练](../docs/history/2026-09-07-complete-rehearsal.md)。第 3 轮无需修复，完整耗时 28.74 分钟；连续稳定复用与第二项目云端接入仍待验证。日常接入只需要 Skill 与项目差异，不读取 ecat 或旧私密脚本。
